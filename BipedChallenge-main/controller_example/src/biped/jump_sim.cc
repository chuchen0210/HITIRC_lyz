  ...
  namespace biped
  {
    namespace
    {
      ...
      int do_main()
      {
        ...
        builder.Connect(plant.get_state_output_port(), estimator->get_state_input_port());
        ...
        auto a_logger = LogVectorOutput(plant.get_generalized_acceleration_output_port(), &builder);
